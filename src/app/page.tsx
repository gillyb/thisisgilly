...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-8 md:p-24">
      ...
      <p className="max-w-2xl text-left w-full dark:text-gray-300">
      ...
      <div className="mt-4 max-w-2xl text-left w-full flex flex-wrap gap-x-10 gap-y-2">
        <div className="flex text-md text-gray-400 dark:text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
          </svg>
          <span className="inline-block ml-1">Toronto, Canada</span>
        </div>
        <div className="flex text-md text-gray-400 dark:text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className="flex text-md text-gray-400 dark:text-gray-600">
          ...
          <span className="inline-block ml-1">+1-437-838-3450, +972-545623450</span>
        </div>
      </div>
